...
const items = [
	...
	{
		img: task,
		title: "Задания и работа над проектом",
		descr:
			"Самая важная часть обучения - это практика. Поэтому ты будешь разрабатывать пет-проект. Я уже придумал идею проекта и полностью спроектировал его, поэтому я буду выступать в роли тим-лида. А если ты хочешь еще больше практики, то у тебя есть возможность поучаствовать в командной разработке моего проекта.",
