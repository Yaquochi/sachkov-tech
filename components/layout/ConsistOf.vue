        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p
                        class="text-white/80 text-lg max-[1300px]:text-base min-h-[140px]"
                    >
                        {{ item.descr }}
                    </p>
                    ...
                    <UAccordion
                        ...
                        variant="outline"
                        :size="
                            $viewport.isLessThan('desktopMedium') ? 'lg' : 'xl'
                        "
                        :items="[
                            {
                                label: item.accTitle,
                        ...
                        <template #item="">
                            <ul class="flex flex-col gap-3 max-[540px]:gap-1">
                                ...
                                >
                                    ...
                                    <p
                                        class="text-lg text-white max-[1300px]:text-base"
                                    >
                                        {{ acc }}
                                    </p>
                                </li>
...
const items = [
    {
        ...
        descr: "У вас сразу будет доступ ко всем записям прошедших занятий, общей длительностью 100+ часов, где разобраны ключевые аспекты разработки, и курс продолжает пополняться новыми материалами.",
    ...
    },
    {
        ...
        descr: "Интенсивы - это набор записей, где я конкретно разбираю большие и сложные темы. Сейчас доступно уже 2 интенсива длительностью 40 часов.",
    ...
    },
    {
        img: review,
        title: "Ревью кода",
        descr: "После того, как ты выполнишь задание и создашь пулл-реквест, я буду проводить код-ревью. Я буду проверять твой код, указывать на ошибки и места, где можно что-то улучшить или доработать. В итоге ты будешь получать полную обратную связь по своему коду.",
    },
    {
        img: chat,
        title: "Доступ к сообществу",
        descr: "Ты сразу получишь доступ к сообществу в телеграмме. Там буду я и все остальные ученики. Здесь ты сможешь отправлять задачи на проверку, подключаться к занятиям, задавать вопросы, получать поддержку по техническим вопросам и общаться в любое время.",
    },
    {
        img: work,
        title: "Помощь и гайды по составлению резюме и поиску работы",
        descr: "На курсе уже много учеников нашли работу. Поэтому у меня есть верная стратегия по составлению резюме и поиску работы. Ты можешь не сомневаться в том, что твоё резюме будет качественно составленно и точно привлечёт внимание компаний.",
    },
];
</script>
